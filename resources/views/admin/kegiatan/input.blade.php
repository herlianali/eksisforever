...
<div class="col-12 stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-description"> Kegiatan baru yang ada di desa </p>
        @if ($errors->any())
        ...
        <form class="forms-sample" method="POST" action=" {{ route('kegiatan.store') }} " enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="date" class="form-control" id="tanggal" placeholder="Masukkan Jumlah Produk" name="tanggal">
            </div>
          </div>
          <div class="form-group row">
