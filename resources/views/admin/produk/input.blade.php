...
<div class="col-12 stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-description"> Produk baru yang ada di desa </p>
        @if ($errors->any())
        ...
        @endif
        <form class="forms-sample" method="POST" action=" {{ route('produk.store') }} " enctype="multipart/form-data">
          @csrf
          <div class="form-group row">
            <label for="namaProduk" class="col-sm-3 col-form-label">Nama Produk</label>
            <div class="col-sm-9">
              <input type="text" class="form-control" id="namaProduk" placeholder="Masukkan Nama Produk" name="namaProduk">
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <textarea name="keterangan" class="form-control" id="keterangan" placeholder="Masukkan Keterangan Produk"></textarea>
            </div>
          </div>
          <div class="form-group row">
